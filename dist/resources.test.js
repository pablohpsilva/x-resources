        ...
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              ...
              expect(
                resourceCreated.every(function (el) {
...
test(
  "fetchSpecificUser from resource",
  /*#__PURE__*/ _asyncToGenerator(
          ...
          switch ((_context3.prev = _context3.next)) {
            ...
            case 2:
              ...
              expect(response.config.url).toBe(
                "".concat(baseURL, "/users/").concat(username)
              );
...
test("applyQueryStringsOnURL should replace correctly the URL", function () {
  ...
  expect((0, _.applyQueryStringsOnURL)(url, params)).toBe(
    "".concat(baseURL, "/1")
  );
});
...
test("prepareBaseURL should return the correct funcion", function () {
  ...
  expect((0, _.prepareBaseURL)(baseURL, url, params)).toBe(
    "".concat(baseURL, "/user/1")
  );
});
