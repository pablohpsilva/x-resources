    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          expect(response.request.res.client._httpMessage.res.responseUrl).toBe("".concat(baseURL, "/users"));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          expect(response.request.res.client._httpMessage.res.responseUrl).toBe("".concat(baseURL, "/users/").concat(username));
